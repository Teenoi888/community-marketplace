      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/register-community" className="bg-white text-primary-700 font-bold px-6 py-3 rounded-xl hover:bg-primary-50 transition-colors flex items-center gap-2">
              เปิดร้านชุมชนฟรี <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/#communities" className="bg-primary-500/40 text-white font-semibold px-6 py-3 rounded-xl hover:bg-primary-500/60 transition-colors">
              ดูสินค้าชุมชน
            </Link>
          </div>
        </div>
