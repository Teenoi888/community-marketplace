...
const addressSchema = z.object({
  ...
  district: z.string().min(2, "กรุณาเลือกอำเภอ/เขต"),
...
export default function CheckoutPage() {
  ...
  function onDistrictChange(e: React.ChangeEvent<HTMLSelectElement>) {
    ...
    if (found) {
      setSelectedZip(found.zipCode)
      setValue("zipCode", found.zipCode)
    } else {
      setSelectedZip("")
      setValue("zipCode", "")
    }
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="lg:col-span-2 space-y-4">
            <div className="card">
              ...
              <div className="mt-4">
                ...
                <textarea {...register("address")} className="input" rows={2} placeholder="123/4 ซอยสุขุมวิท 11 ถนนสุขุมวิท" />
